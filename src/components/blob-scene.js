...
function Swarm({ count, mouse, swarmColor }) {
  const mesh = useRef()
  ...
  return (
    <>
      <instancedMesh ref={mesh} args={[null, null, count]} castShadow receiveShadow>
        ...
        <meshPhongMaterial color={swarmColor}/>
      </instancedMesh>
    </>
  )
}

function BlobScene({ swarmCount, intensity, swarmColor }) {
  return (
    <Canvas
      shadowMap
      ...
      <Swarm count={swarmCount} swarmColor={swarmColor} />
