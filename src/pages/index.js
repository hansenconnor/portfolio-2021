        ...
        <div className="page">
          ...
          <section ref={clientsRef} className="min-h-1/2-screen flex items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              ...
              <div className="flex items-center md:justify-center" data-scroll data-scroll-speed="2">
                <div>
          ...
          {/* <section>
            <img src={IBMScreen} alt="" data-scroll data-scroll-speed="3" />
          </section> */}
            ...
            <div className="section-content py-32">
              ...
              <div className="featured-projects">
                <div className="featured-project py-24 flex flex-col lg:flex-row lg:items-center">
                  <figure className="featured-project__image block w-full lg:w-3/5" data-scroll data-scroll-speed="1">
                ...
                <div className="featured-project py-24 flex flex-col lg:flex-row lg:items-center">
                  ...
                  <article className="featured-project__copy flex flex-col justify-center py-8 md:p-8 w-full lg:w-2/5" data-scroll data-scroll-speed="1">
          ...
          <section className="min-h-3/4-screen flex items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              <div className="flex items-center md:justify-center">
                <div>
                  <h3><span className="block">Are you reacy to start</span><span className="block">your next project?</span></h3>
                  <p className="mb-8 mt-6"><span className="block">User-centric design that beats the competition.</span><span className="block">Time and time again.</span></p>
                  <CustomLink to="/contact">Send me a message</CustomLink>
                </div>
              </div>
